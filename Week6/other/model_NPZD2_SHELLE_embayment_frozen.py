...
def load_defaults():
    ...
    par['X'] = 1.#2000 # Basin length
    par['Y'] = 1.#200 # Basin width
    par['Z'] = 1. # Basin depth
...
def plot(output):
    ...
    ax1.set_title('Fennel et al 2006 Model - Limitations')
    ...
    ax2.set_title('Fennel et al 2006 Model - State')
    ...
    ax3.set_title('Fennel et al 2006 Model - State - Oxygen')
    plt.legend(['Oxy'])
    plt.show()
    ...
    ax4.set_title('SHELL-E Model - Limitations')
    ...
    ax5.set_title('SHELL-E Model - State')
