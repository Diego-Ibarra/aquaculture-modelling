...
fig1 = pexp.densityVSproduction(Tank1_multioutput)
fig1.savefig('Exp3_Embayment_lowFlow_densVsprod.png')

fig2 = pexp.densityVSoxygen(Tank1_multioutput)
fig2.savefig('Exp3_Embayment_lowFlow_densVsoxy.png')

fig3 = pexp.densityVSammonia(Tank1_multioutput)
fig3.savefig('Exp3_Embayment_lowFlow_densVsammonia.png')
